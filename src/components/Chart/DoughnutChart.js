  ...
  return (
    <div className="bg-white dark:bg-darkCard p-2 md:py-4 lg:py-8 lg:px-4 rounded z-[4]">
      ...
      <div className="w-[244px] h-[244px] mx-auto">
        <div className="inner relative dark:bg-myBlack">
          <div style={doughnutStyle}>
            <h4 className="text-2xl text-myBlue dark:text-myPink font-semibold">
              23.6K
            </h4>
            <span className="text-myBlack dark:text-white text-base">
              USERS
            </span>
          </div>
      ...
      <div className="flex gap-3 flex-wrap justify-around mt-10">
        <div>
          <h5 className="text-xl text-myBlue dark:text-myGreen text-center">
            Mobile
          </h5>
          <h3 className="text-myBlack font-bold text-2xl dark:text-white text-center">
            91.434%
          </h3>
        </div>
        ...
        <div>
          ...
          <h3 className="text-myBlack font-bold dark:text-white text-2xl text-center">
            93.64%
          </h3>
        </div>
        <div className="w-[1px] bg-[#ECEEFB]"></div>
