  ...
  return (
    <div className="bg-white p-3 lg:px-7 lg:py-8  dark:bg-darkCard rounded">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="text-sm px-4 py-3 bg-myBlue dark:bg-myGreen text-white rounded">
          Add
        </button>
      </div>
      ...
      <button className="text-sm text-white px-4 py-3 bg-myBlue dark:bg-myGreen rounded mt-8">
        Update Password
      </button>
    </div>
  );
