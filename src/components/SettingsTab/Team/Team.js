...
const Team = () => {
  return (
    <div className="bg-white dark:bg-darkCard p-3 lg:px-7 lg:py-8 rounded w-full">
      <h4 className="text-2xl text-myBlack font-semibold mb-4 lg:mb-8">
        Team settings
      </h4>
      <div className="overflow-x-auto">
        <table className="table overflow-hidden whitespace-nowrap w-full">
          ...
          <tbody>
            {teams.map((team) => (
              <tr key={team.id} className="dark:border-darkLine border-myLine">
                <th>
                  <label>
                    <input
                      type="checkbox"
                ...
                <td>
                  <div className="flex items-center space-x-3">
                    <div className="text-base text-myBlue dark:text-myGreen">
                      {team.role}
                    </div>
                  </div>
                </td>
