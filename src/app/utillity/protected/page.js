            ...
            <div className=' flex h-[100vh] items-center justify-center text-center'>
                <div className='bg-white dark:bg-darkCard cardShadow roundded p-3 sm:px-10 sm:py-8 relative'>
                    ...
                    <div className='w-20 h-20 md:w-32 md:h-32 lg:w-[160px] lg:h-[160px] bg-white dark:bg-[#1E192A] p-10 cardShadow rounded-full mx-auto flex items-center justify-center'>
                        <span class="material-symbols-outlined text-5xl md:text-7xl lg:text-[80px] text-myBlack dark:text-myWhite ">lock</span>
                    </div>
                    <h2 className='text-2xl sm:text-[40px] text-myBlack dark:text-myWhite font-semibold mt-3 mb-3 sm:mb-6 sm:mt-8'>This link is password protected</h2>
                    <span className='text-lg text-myGrey dark:text-myLine'>Please enter the password to view this link.</span>
                    ...
                    <button className="w-full px-4 py-3 text-sm bg-myBlue dark:bg-myGreen text-white dark:text-[#1E192A] rounded mt-3 sm:mt-7">Submit</button>
                </div>
            </div>
        </div>
    );
