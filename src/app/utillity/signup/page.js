...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-wrap bg-[#ECEEFB] dark:bg-darkBg">
      <div className="lg:w-1/2  w-full bg-[#4F45B6] dark:bg-gradient-to-r from-authColor to-darkBg relative">
        <Link
          href="/"
          className="flex items-center gap-2 ml-10 mt-10 mb-[60px] cursor-pointer"
        >
          <Image className="w-[31px] h-[36px]" src={logo} alt="company logo" />
          <h1 className="text-white text-2xl font font-bold">Dashpro</h1>
        </Link>
        <div className="flex h-[70vh] items-center justify-center">
          <Image className=" object-cover" src={animation} alt="animation" />
        </div>
        ...
        <div className="text-center pb-[60px] sm:block hidden">
          ...
          <h5 className="text-xl text-white mt-5">
            Start your Dashpro journey now!
          </h5>
        </div>

        <Image
          className="w-15 h-15 lg:w-[129px] lg:h-[127px] absolute left-10 top-[172px] sm:flex hidden"
          src={warth}
          alt="circel"
        />
        <Image
          className="w-[129px] h-[127px] absolute right-[67px] top-[133px] sm:flex hidden"
          src={warth}
          alt="circel"
        />
        <Image
          className="w-[72px] h-[71px] absolute right-[34px] bottom-[35px]"
          src={warth}
          alt="circel"
        />
        <Image
          className="w-[59px] h-[59px] absolute left-[18%] bottom-[20%]"
          src={warth}
          alt="circel"
        />
        <Image
          className="w-[59px] h-[59px] absolute left-[75px] bottom-[64px]"
          src={warth}
          alt="circel"
        />

        <Image
          className="absolute top-[30%] left-[33%] w-[37px] h-[37px] rounded-full run1"
          src={authFacebook}
          alt="Facebook"
        />
        <Image
          className="absolute top-[43%] right-[28%] w-[37px] h-[37px] rounded-full run"
          src={authApple}
          alt="apple"
        />
        <Image
          className="absolute top-[28%] right-[23%] w-[37px] h-[37px] rounded-full run"
          src={authTwiter}
          alt="Twiter"
        />
        <Image
          className="absolute top-[48%] left-[20%] w-[37px] h-[37px] rounded-full run1"
          src={authGoogle}
          alt="Google"
        />
      </div>
      ...
      <div className=" lg:w-1/2 w-full relative cardShadow">
        <div className=" flex h-[100vh] items-center justify-center">
          <div className="w-full lg:w-4/5 bg-white dark:bg-darkCard p-3 lg:px-8 lg:py-7 rounded">
            <h3 className="text-2xl lg:text-[32px] text-myBlack dark:text-white  text-center font-semibold">
              Sign Up to Dashpro
            </h3>
            ...
            <form>
              <div className="form-control w-full mb-5">
                ...
                <input
                  type="text"
                  placeholder="Name..."
                  className="px-[18px] py-2 bg-[#ECEEFB] dark:bg-[#1E192A] text-myBlack dark:text-myWhite outline-none rounded"
                />
              </div>
              <div className="form-control w-full mb-5">
                <label className="label">
              ...
              <div className="form-control mb-5">
                ...
                <label className="label">
                  <Link
                    href="#"
                    className="text-myGrey dark:text-myWhite text-xs"
                  >
              ...
              <div className="flex flex-wrap justify-between items-center">
                <div className="form-control">
                  <label className="flex items-center gap-[10px] cursor-pointer">
                    <input
                      type="checkbox"
                      className="checkbox checkbox-primary dark:checkbox-success"
                    />
                    <span className="text-xl text-myBlack dark:text-myWhite">
                      Remember me
                    </span>
                  </label>
                </div>
                <Link
                  href="#"
                  className="text-myBlue dark:text-myGreen text-lg"
                >
                  Forgot Password?
                </Link>
              </div>
              <div className="mt-10 w-4/5 mx-auto">
                <button className="w-full px-4 py-3 text-sm bg-myBlue dark:bg-myGreen text-white dark:text-[#1E192A] rounded">
                  Register
                </button>
              </div>
              <span className="text-myBlack dark:text-myWhite block text-center text-lg mt-3">
                Already have an account?{" "}
                <Link
                  href="/utillity/signin"
