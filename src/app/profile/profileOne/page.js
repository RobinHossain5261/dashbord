...
const profileOne = () => {
    ...
    return (
        <div className='bg-bgColor dark:bg-darkBg'>
            ...
            <div className='px-6 pt-10 block lg:flex gap-6 relative'>
                ...
                <div className='py-10 px-8 rounded h-full bg-white dark:bg-darkCard cardShadow'>
                    ...
                    <h4 className='text-2xl font-semibold text-myBlack dark:text-white mt-10 mb-8'>About Us</h4>
            ...
            <div className='px-6 pb-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 '>
                    <div className='p-5 rounded bg-white dark:bg-darkCard cardShadow'>
                        ...
                        <p className='text-lg text-myGrey mt-8 dark:text-myLine'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                    </div>
                    <div className='p-5 rounded bg-white dark:bg-darkCard cardShadow'>
                        <div className='flex items-center justify-between flex-wrap'>
                            <div className='flex items-center gap-3'>
