    ...
    return (
        <div className='px-2 lg:px-6 pt-8 pb-6 bg-bgColor dark:bg-darkBg min-h-screen'>
            ...
            <div className='my-5 lg:my-10 py-3 lg:px-2 flex flex-wrap gap-3 lg:gap-6'>
                <Link href='/integrations' className='text-myBlack dark:text-myWhite py-3 px-4 text-sm border border-myLine dark:border-darkLine rounded'>All</Link>
                ...
                <Link href='/integrations/streaming' className='flex items-center gap-4 py-3 px-4 border border-myLine dark:border-darkLine rounded bg-myBlue dark:bg-myGreen text-white dark:text-[#1E192A]' >
