                    ...
                    <Tab.Panel className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                        {
                            ...
                            >
                                ...
                                <Link href="/integrations/integrationsSingle" className='text-sm text-white dark:text-[#1E192A] bg-myBlue dark:bg-myGreen px-4 py-3 rounded'>View integrations</Link>
                            </div>))
                        }
                    </Tab.Panel>
                    <Tab.Panel className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
