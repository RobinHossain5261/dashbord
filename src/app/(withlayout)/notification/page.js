        ...
        <div className="p-2 sm:px-8 sm:py-7 bg-white dark:bg-darkCard rounded">
          <Tab.Group>
            <Tab.List className="flex flex-wrap gap-2 justify-between items-center">
              <h3 className="text-2xl sm:text-[32px] text-myBlack dark:text-myWhite font-semibold">
                Notification center
              </h3>
                ...
                >
                  {({ selected }) => (
                    <div
                      className={
                        selected
                          ? "bg-myBlue dark:bg-myGreen text-white flex"
                          : " text-myBlack dark:text-myWhite flex"
                      }
                    >
            ...
            <Tab.Panels>
              <Tab.Panel>
                <section>
                  <h4 className="text-xl text-myBlack dark:text-white mb-6">
                    Today
                  </h4>
                  <div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap justify-between items-center">
                            <div className="flex items-center gap-1">
                              <span className="text-myBlack dark:text-myLine">
                                {notification.time}
                              </span>
                              <div className="w-[6px] h-[6px] bg-[#FFA5A5] rounded-full"></div>
                            </div>
                            <span className="text-xs text-myBlue dark:text-myGreen">
                              {notification.date}
                            </span>
                          </div>
                        </div>
                ...
                <section className="mt-[30px]">
                  <h4 className="text-xl text-myBlack dark:text-myWhite mb-6">
                    Yesterday
                  </h4>
                  <div>
