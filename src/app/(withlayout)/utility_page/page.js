      ...
      <div className="flex flex-wrap gap-6 mt-8">
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkSignUp : signUp}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 object-cover w-[270px] h-[150px]"
            />
          </figure>
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkSignIn : signIn}
              alt="page"
        ...
        <Link
          href="/utillity/verifyemail"
          className="card  bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkVerify : verify}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkNotification : notification}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkNotes : notes}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
        ...
        <Link
          href="/utillity/resetpassword"
          className="card bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkResetPass : resetPass}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkPassProtected : passProtected}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
        ...
        <Link
          href="/utillity/errorpage"
          className="card bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkError : error}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500 w-[270px] h-[150px]"
            />
          </figure>
