    ...
    <div className="px-3 lg:px-6 pb-6 pt-10 bg-bgColor dark:bg-darkBg min-h-screen ">
      ...
      <div className="flex flex-wrap gap-6 mt-8">
        <Link
          ...
          className="card w-[300px] h-[350px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkProfile1 : profile1}
              alt="page"
        ...
        <Link
          href="/profile/profile_two"
          className="card w-[300px] h-[350px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkProfile2 : profile2}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
        ...
        <Link
          href="/profile/profile_three"
          className="card w-[300px] h-[350px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkProfile3 : profile3}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
