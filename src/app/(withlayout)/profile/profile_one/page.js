  ...
  return (
    <div className="bg-bgColor dark:bg-darkBg">
        ...
        <div className="p-2 md:p-6 lg:py-10 lg:px-8 rounded h-full bg-white dark:bg-darkCard cardShadow">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            <div className="flex flex-wrap items-center gap-5">
              ...
              />
              <div>
                <h3 className="text-3xl flex flex-wrap whitespace-nowrap font-semibold text-myBlack dark:text-white">
                  Data Coordiator
                </h3>
                <span className="text-sm text-myGrey dark:text-white">
                  Bluth CEO
                </span>
              </div>
            </div>
            ...
            <div
              className="flex items-center gap-1 lg:gap-2 bg-myBlue dark:bg-myGreen rounded p-2 lg:py-3 lg:px-4 cursor-pointer"
          ...
          <h4 className="text-2xl font-semibold text-myBlack dark:text-white mt-4 mb-3 lg:mt-10 lg:mb-8">
            About Us
          </h4>
      ...
      <div className="p-3 lg:px-6 pb-6">
        <h4 className="text-2xl text-myBlack dark:text-white font-semibold mb-6">
          Experience
        </h4>
