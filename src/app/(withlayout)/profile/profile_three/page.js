    ...
    <div className="px-3 lg:px-6 pt-10 pb-6 bg-bgColor dark:bg-darkBg">
      <div className="block lg:flex gap-6">
        <section className="bg-white dark:bg-darkCard p-2 lg:py-7 lg:px-5 h-full rounded cardShadow mb-6">
          ...
          <span className="text-sm text-myGrey dark:text-myWhite mt-2 ">
            Bluth CEO
          </span>
        ...
        <section className="">
          ...
          <div className="p-3 lg:py-10 lg:px-8 rounded bg-white dark:bg-darkCard cardShadow">
            <h4 className="text-2xl text-myBlack dark:text-white mb-4 lg:mb-8 font-semibold">
              About Us
            </h4>
            <p className="text-base mb-7 dark:text-myWhite text-justify	">
              Lorem ipsum dolor sit amet consectetur. Volutpat mattis turpis
              lorem luctus. Et sed ornare at fermentum vestibulum sit. A sem
              faucibus cursus pretium vel vitae pellentesque sed vulputate. In
              turpis leo dictum est id. Sed mi sed neque quam sit.
            </p>
            <p className="text-base mb-7 dark:text-myWhite text-justify	">
            ...
            <p className="text-base dark:text-myWhite text-justify	">
              Lorem ipsum dolor sit amet consectetur. Euismod vel ut aliquet
          ...
          <div className="p-3 lg:py-7 lg:px-8 rounded bg-white dark:bg-darkCard cardShadow">
            <h4 className="text-2xl text-myBlack font-semibold dark:text-white mb-5 lg:mb-10">
              Experience
            </h4>
            ...
            <p className="text-lg text-myGrey mt-4 lg:mt-8 dark:text-myLine text-justify">
              Lorem ipsum dolor sit amet consectetur. Et eu facilisi facilisi
              quis lobortis tincidunt in neque eget. Sed malesuada orci risus
              risus.
            </p>
