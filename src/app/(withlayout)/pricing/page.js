  ...
  return (
    <div className="px-3 lg:px-6 pb-6 pt-10 bg-bgColor dark:bg-darkBg min-h-screen ">
      ...
      <div className="flex flex-wrap gap-6 mt-8">
        <Link
          href="/pricing/pricing_one"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkPricing1 : pricing1}
              alt="page"
        ...
        <Link
          href="/pricing/pricing_two"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkPricing2 : pricing2}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
        ...
        <Link
          href="/pricing/pricing_three"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkPricing3 : pricing3}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
        ...
        <Link
          href="/pricing/pricing_single"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkSinglePrice : singlePrice}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
