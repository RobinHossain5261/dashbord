        ...
        <Tab.Panels>
              ...
              <div className="flex flex-wrap gap-2 justify-between items-center">
                ...
                <div>
                  <Listbox value={selectedPerson} onChange={setSelectedPerson}>
                    <Listbox.Button className="flex gap-2 items-center  relative w-full rounded-lg text-[#252525] dark:text-myWhite  py-2 px-3 text-left border border-myLine dark:border-darkLine focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm cursor-pointer">
                      {selectedPerson.name}
          ...
          <Tab.Panel>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
              {companiesData.map((buyer) => (
                <div
                  key={buyer.id}
                  className="bg-white dark:bg-darkCard p-2 lg:px-8 lg:py-7 rounded"
                >
                  <Image
                    className="w-20 h-20 cardShadow border-8 border-white dark:border-darkBg rounded-full mx-auto"
                    src={buyer.img}
                    alt="buyer"
                  />
