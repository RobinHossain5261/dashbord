...
const SettingsThree = () => {
  ...
  return (
    <div className="px-3 pt-11 sm:pb-6 lg:px-6 bg-bgColor dark:bg-darkBg">
      <h3 className="font-semibold text-myBlack text-[32px] dark:text-white">
        General settings
      </h3>
        ...
        <section className="bg-white dark:bg-darkCard p-2 lg:py-7 lg:px-8 rounded cardShadow h-full mb-6">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-3 left-[46%]"
            >
              <span className="w-[30px] h-[30px] rounded-full bg-myBlue dark:bg-myGreen flex items-center justify-center">
                <span className="material-symbols-outlined w-6 h-6 text-white">
                  add_photo_alternate
                </span>
              </span>
            </button>
          </div>
          <h5 className="text-myBlack text-xl font-semibold text-center mt-3 mb-6">
