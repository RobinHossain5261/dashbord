      ...
      <div className="flex flex-wrap gap-6 mt-8">
        ...
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? account2 : account1}
              alt="page"
        ...
        <Link
          href="/settings/settings_two"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkAccountv2 : accountv2}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
        ...
        <Link
          href="/settings/settings_three"
          className="card w-[300px] h-[300px] bg-white dark:bg-darkCard shadow-xl group"
        >
          <figure className="px-5 pt-5">
            <Image
              src={resolvedTheme === "dark" ? darkAccountv3 : accountv3}
              alt="page"
              className="rounded group-hover:scale-125 transition-all duration-500"
            />
          </figure>
