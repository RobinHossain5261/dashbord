  ...
  return (
    <div className="pt-2 bg-bgColor dark:bg-darkBg">
      <div className="h-[300px] bg-[#1E192A] flex justify-center relative -mb-28">
        <Image
          className="absolute top-2 left-[66px] object-cover hidden md:flex lg:flex"
          src={settings}
          alt="settings"
        />
        <h1 className="text-3xl lg:text-5xl text-white font-semibold absolute top-[60px]">
          Account Settings
        </h1>
        <Image
          className="absolute top-2 right-10 object-cover hidden md:flex lg:flex"
          src={settings1}
          alt="settings"
        />
      </div>
            ...
            <div className="bg-white  dark:bg-darkCard h-full rounded cardShadow p-3 lg:py-7 lg:px-8 mb-6">
              <div className="relative mb-8">
                ...
                <button
                  ...
                  className="hidden md:flex lg:flex items-center gap-2 bg-myBlue dark:bg-myGreen absolute bottom-5 right-5 rounded py-3 px-4"
                >
