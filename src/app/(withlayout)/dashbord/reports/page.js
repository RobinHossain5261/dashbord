...
const Reports = () => {
  ...
  return (
    <div className="px-3 lg:px-6 pt-10 bg-bgColor dark:bg-darkBg">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 mb-6">
        {reportCards.map((card) => (
          ...
          >
            <div className="flex justify-between flex-wrap">
              <h3 className="text-base text-myBlack dark:text-white">
                {card.name}
              </h3>
              <span className="group-hover:shadow-xl duration-500 p-2 bg-[#F1F1FA] dark:bg-[#21574B] text-myBlue dark:text-myGreen flex justify-center items-center rounded boxShadow">
                {card.icon}
              </span>
            </div>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div
                className="group px-2 rounded  flex items-center justify-center"
                style={{
                  backgroundColor:
                    resolvedTheme === "dark"
                      ? `${card.bgColor2}`
      ...
      <section className=" bg-white dark:bg-darkCard rounded p-2 lg:p-5 lg:py-[60px] lg:pl-[60px] lg:pr-[58px] boxShadow">
        <div className="flex flex-wrap gap-2 justify-between">
          <h3 className="text-xl text-myBlack dark:text-white">
            Monthly page views
          </h3>
          <div>
      ...
      <section className="my-6 rounded  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-darkCard rounded boxShadow dark:darkShadow">
          <div className="p-2 lg:p-7">
            <h5 className="text-base text-myBlack dark:text-white mb-4">
              Page views
            </h5>
        ...
        <div className="bg-white dark:bg-darkCard dark:text-white rounded boxShadow">
          <div className="p-2 lg:p-7">
            <h5 className="text-base dark:text-white text-myBlack mb-4">
              New sign ups
            </h5>
            <div className="flex justify-between">
              <h3 className="text-2xl text-myBlack dark:text-white font-semibold">
