            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 mb-6">
                {
                    reportCards.map(card => (<div
                        ...
                        <div className="flex justify-between flex-wrap">
                            ...
                            <span className="group-hover:shadow-xl duration-500 p-2 bg-[#F1F1FA] dark:bg-[#21574B] text-myBlue dark:text-myGreen flex justify-center items-center rounded boxShadow">{card.icon}</span>
                        </div>
