            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8'>
                ...
                <div className='bg-white dark:bg-darkCard rounded p-2 lg:px-10 lg:pt-10 lg:pb-6'>
                    ...
                    <div className='flex justify-between'>
                        <div>
                            <span className='text-xl text-myBlack dark:text-white font-semibold mt-2'>$209,907.00</span>
                        </div>
                                    ...
                                    productLists.map(product => (<tr
                                        ...
                                        <td>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="text-base text-myBlack font-semibold dark:text-white">{product.name}</div>
                                                    <div className="text-base text-myBlack dark:text-myWhite">{product.post}</div>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <table className="table whitespace-nowrap">
                        ...
                        <thead className='bg-[#F5F7FD]  dark:bg-darkBg text-lg    '>
                            <tr className='border-myLine dark:border-darkLine text-myBlack dark:text-white'>
                                ...
                                <th className='text-lg font-normal text-myBlack dark:text-white'>Product No</th>
                                <th>
