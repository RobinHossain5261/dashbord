    ...
    <div className="px-3 pt-11 pb-6 lg:px-6 bg-bgColor dark:bg-darkBg">
      <div className="block lg:flex gap-6">
        <section className="bg-white dark:bg-darkCard p-2 lg:py-7 lg:px-5 h-full rounded cardShadow mb-6">
          ...
          <h3 className="text-[#1E192A] dark:text-white text-2xl md:text-3xl lg:text-[32px] mt-[30px] font-semibold ">
            Jenny Pilson
          </h3>
          <span className="text-base text-myGrey dark:text-myWhite mt-2 ">
            UI/UX Designer
          </span>
        ...
        <section className="w-full">
          ...
          <div className="bg-white dark:bg-darkCard text-myBlack dark:text-white rounded p-2 lg:py-7 lg:px-8 ">
            ...
            <div className="mt-10 flex gap-2 flex-wrap justify-between">
              ...
              <button className="bg-myBlue dark:bg-myGreen text-base text-white dark:text-myBlack px-4 py-3 rounded">
                Create note
              </button>
            </div>
          </div>
            ...
            <div>
              <div className="timeline dark:before:bg-myBlack relative">
                <div className="p-2 sm:py-7 sm:px-8 bg-white dark:bg-darkCard rounded ml-16 sm:ml-20">
                  ...
                  <p className="text-base text-myGrey dark:text-myWhite my-3 sm:my-5 text-justify">
                    Lorem ipsum dolor sit amet consectetur. Volutpat mattis
                    turpis lorem luctus. Et sed ornare at fermentum vestibulum
                    sit. A sem faucibus cursus pretium vel vitae pellentesque
                    sed vulputate. In turpis leo dictum est id.
                  </p>
                  <p className="text-base text-myGrey dark:text-myWhite my-3 sm:my-5 text-justify">
                    Lorem ipsum dolor sit amet consectetur. Euismod vel ut
                    aliquet cursus arcu quisque suspendisse vel tincidunt.
                    Sagittis aliquet dignissim tortor et purus. Risus diam
                    pharetra enim sit ut dis ut cursus eget.{" "}
                  </p>
                  <hr className="border-myLine dark:border-darkLine" />
                  <div className="mt-5 flex flex-wrap gap-2 items-center justify-between">
                    <div className="flex gap-3 items-center">
                      <Image
                        className="w-[60px] height-[60px] rounded-full"
                        src={jenny}
                        alt="people"
                      />
                      <h5 className="text-xl text-myBlack dark:text-white">
                        Jenny Pilson
                      </h5>
                    </div>
                    <div className="flex gap-2">
                      <span className="material-symbols-outlined text-myBlue dark:text-myGreen bg-[#ecebfb] dark:bg-[#22574b] p-1 rounded-[8px]">
                        edit
                      </span>
                      <span className="material-symbols-outlined text-myBlue dark:text-myGreen bg-[#ecebfb] dark:bg-[#22574b] p-1 rounded-[8px]">
                        more_horiz
              ...
              <div className="timeline dark:before:bg-myBlack relative my-5">
                <div className="p-2 sm:py-7 sm:px-8 bg-white dark:bg-darkCard rounded ml-16 sm:ml-20">
                  ...
                  <p className="text-base text-myGrey dark:text-myLine mt-3 sm:mt-5">
                    submitted{" "}
              ...
              <div className="timeline dark:before:bg-myBlack relative overflow-y-hidden mt-5">
                <div className="p-2 sm:py-7 sm:px-8 bg-white dark:bg-darkCard rounded ml-16 sm:ml-20">
                  ...
                  <p className="text-base text-myBlue dark:text-myGreen mt-3 sm:mt-5">
                    Blog Newsletter
                  </p>
                </div>
                <div className="rounded-full text-white dark:text-myBlack bg-myBlue dark:bg-myGreen w-[60px] h-[60px] flex items-center justify-center iconCenter">
