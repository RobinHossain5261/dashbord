        ...
        <div className='px-2 lg:px-6 pt-10 pb-6 bg-bgColor dark:bg-darkBg'>
            ...
            {/* <Tabs className="mt-8">
                <TabList className='flex gap-6'>
                    ...
                    <Tab style={{ backgroundColor: bgColor === true ? '#4538D3' : '', color: bgColor === true ? '#FFFFFF' : '' }} onClick={() => setBgColor(true)} className={`text-sm text-black dark:text-myWhite py-3 px-4 border border-myLine dark:border-darkLine rounded cursor-pointer outline-0`}>Table view</Tab>

                    <Tab style={{ backgroundColor: bgColor === false ? '#4538D3' : '', color: bgColor === false ? '#FFFFFF' : '' }} onClick={() => setBgColor(false)} className={`text-sm text-black dark:text-myWhite py-3 px-4 border border-myLine dark:border-darkLine rounded cursor-pointer outline-0`}>Card view</Tab>
                </TabList>
